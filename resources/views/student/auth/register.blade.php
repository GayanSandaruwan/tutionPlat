        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a class="btn btn-link" href="{{ url('/teacher/register') }}">
                        Or do you want to register as a Teacher?
                    </a>
                </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/student/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="custom-select custom-select-lg mb-3" id="gender" name="gender" value="{{old('gender')}}">
                        ...
                        <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    ...
                                    <a class="btn btn-link" href="{{ url('/student/login') }}">
